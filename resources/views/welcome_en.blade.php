...
<body>
    <header>
        ...
        <nav class="navbar1"><a href="admin/login" target="blank">Get into</a>
            <a href="#contenedor-formulario">Contact</a>
            <a href="#servicios">Services</a>
            <a href="#aliado">Allies</a>
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class='carousel-item <?php echo $set_; ?>'>
                    <h5 class="descripcion">{{ $slider->descripcion_ingles }}</h5>
    ...
    <section>
        ...
        <p class="textos">
            ...
            It is a company specialized in transportation services for executives, hotel guests, businessmen and
            tourists in the city of Medellin and the department of Antioquia.
        </p>
    </section>
                ...
                <figure>
                    ...
                    <a href="{{ route('home.show', ['id' => $servicio->id]) }}">
                        <button type="button" class="btn btn-secondary" data-bs-toggle="modal"
                            data-bs-target="#exampleModal">See detail<i class="fa fa-eye"></i></button>
                    </a>
                    <a type="button" class="btn btn-info" title="Añadir este producto al carrito"
                        href="{{ route('products.list') }}">Quote<i class="fa fa-taxi"></i></a>
    ...
    <!--=============================SECCION ALIADOS============================= -->
    <br>
    <h2 id="aliado" class="titulo-principal">Allies</h2>
    <br><br>
    <center>
        <section>
        ...
        <div id="local" class="border-top border-2">
            ...
            <div>
                ...
                <div class="wrapper-local  text-center ">
                    <h2 class="titulo-principal">Our location</h2>
                </div>
                <br>
                <br>
            </div>
    ...
    <section style="background-image: url('images/act.png'); background-repeat:no-repeat; width:100%;">
        ...
        <div class="form_container">
            <form action="{{ route('home.store') }}" class="form">
                ...
                <br>
                <p style="color:black">Select the company:</p>
                ...
                <input type="text" class="form-input" id="name" name="name"
                    placeholder="Write your name:" onkeypress="txNombres()" required>

                <input type="email" class="form-input" id="email" name="email"
                    placeholder="Write your email:" required>

                <input type="text" class="form-input" name="cell_phone" id="cell_phone"
                    placeholder="Write your phone:" maxlength="10" onkeypress="ValidaSoloNumeros()" required>
                ...
                <div class="botones">
                    ...
                    <button type="reset" class="boton-borrar">Delete data</button>
                </div>
            </form>
        </div>
        <br>
...
<section>
    ...
    <div class="chat-popup" id="myForm">
        <form action="{{ route('home.guardarChat') }}" class="form-container" method="POST">
            @csrf
            <div style="width: 50px; height: 40px; " class="">
                <button class="btn btn-danger" onclick="closeForm()">
    ...
    <section>
        <footer class="w-100  d-flex  align-items-center justify-content-center flex-wrap"
            ...
            <p class="fs-5 px-3  pt-3 " style="color: white;">UST. &copy; All rights reserved 2022</p>
            <div id="iconos">
